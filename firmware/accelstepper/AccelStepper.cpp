...
//////////////////////////////////////////////////////////////////
// The following are a quick port into the pico SDK added by JPN
...
static inline void pinMode(uint pin, bool output)
{
    gpio_init(pin);
...
static inline float constrain(float val, float a, float b)
{
    if (val < a) return a;
    if (val > b) return b;
    return val;
